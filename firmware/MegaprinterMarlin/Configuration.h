...
#define STRING_CONFIG_H_AUTHOR "tobbelobb w/ modifications by Chris Dagher" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "MEGAPRINTER"
...
// line diameter 0.4, spool height 10
// approximating volume taken by line on spool to have quadratic cross section gives
// 0.4*0.4/(pi*10) = 0.005093
#define DEFAULT_SPOOL_BUILDUP_FACTOR 0.005093
...
const float SPOOL_RADII[DIRS] = { 97.5, 97.5, 97.5, 97.5 };
...
#ifdef EXTRUDERS
#define TEMP_SENSOR_0 1 // Setting gotten from thermistor manufacturer
...
#define DEFAULT_ESTEPS 70 // 1/8 ustep @ 200 steps/rev with auger
